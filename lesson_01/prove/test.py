...
New functions
'''
def draw_squares_thread(tur, lock_square):
    """Draw a group of squares"""
    for x in range(-300, 350, 200):
        for y in range(-300, 350, 200):
            with lock_square:
...
def draw_circles_thread(tur, lock_circle):
    """Draw a group of circles"""
    for x in range(-300, 350, 200):
        for y in range(-300, 350, 200):
            with lock_circle:
...
def draw_triangles_thread(tur, lock_triangle):
    """Draw a group of triangles"""
    for x in range(-300, 350, 200):
        for y in range(-300, 350, 200):
            with lock_triangle:
...
def draw_rectangles_thread(tur, lock_rectangle):
    """Draw a group of Rectangles"""
    for x in range(-300, 350, 200):
        for y in range(-300, 350, 200):
            with lock_rectangle:
